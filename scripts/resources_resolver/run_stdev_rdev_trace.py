...
# === Configuration ===
SCRIPT_LOCAL = os.path.join("scripts","resources_resolver","find_rdev_stdev_inode.sh")
...
PYTHON_PROCESSOR = os.path.join("scripts","resources_resolver","create_cat2_devs.py")
