...
Taken together, these observations indicate that a significant research gap remains. There is a clear need for techniques that combine the lightweight footprint and high-fidelity visibility of kernel-level tracing with the contextual insights gained from static inspection. The goal is to enrich the raw, system-wide signals with enough application-specific context for meaningful privacy and security reasoning—ideally without requiring custom firmware or invasive system modifications. This thesis directly addresses this gap.
% --------------------------------------------------
