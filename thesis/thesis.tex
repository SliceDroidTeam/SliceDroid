...
\begin{itemize}
\item \textit{Package Scope:} The mapping algorithm reliably lists user-installed APKs but excludes protected system apps like Chrome; full coverage would require elevated privileges or alternative enumeration.
...
\vspace{0.4em}
\textbf{Appendix A – Code:} Selected scripts and configuration files used for static analysis, tracing, and post-processing.
